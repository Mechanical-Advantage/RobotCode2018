 ...
 * 
 * <p>This version has a fixed setToleranceBuffer
 */
public class PIDControllerFixed extends SendableBase implements PIDInterface, Sendable {
  ...
  private class PIDTask extends TimerTask {
    private PIDControllerFixed m_controller;

    PIDTask(PIDControllerFixed controller) {
